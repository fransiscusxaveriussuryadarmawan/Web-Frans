                ...
                <div class="container px-lg-5">
                    ...
                    <div class="row g-5 align-items-end">
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            <h1 class="text-white mb-4 animated slideInDown">Version Canva Pro (30 Days) --- Expired 2
                            ...
                            <a href="https://sub4unlock.io/RIwY8" class="btn btn-secondary py-sm-3 px-sm-5 rounded-pill me-3 animated slideInLeft">Click
                                This For Join</a>
                            <a href="https://sub4unlock.io/RIwY8" class="btn btn-light py-sm-3 px-sm-5 rounded-pill animated slideInRight">SPECIAL TEAM 47
                                [1]</a>
                        </div>
                        <div class="col-lg-6 text-center text-lg-start">
