            ...
            <div class="px-lg-5 container">
                ...
                <div class="row g-5 align-items-center">
                    <div class="text-center col-lg-6 text-lg-start">
                        <h1 class="mb-4 text-white animated slideInDown">Version Canva Pro (30 Days) --- Expired 29 January 2025 Premium<br>⭐⭐⭐⭐⭐</h1>
                ...
                <div class="row justify-content-center mt-5">
                    <div class="mb-4 col-lg-10">
                        <div class="bg-light p-4 card shadow-sm border-info">
                            <h3 class="text-center mb-3 text-info">Cara Bergabung</h3>
                            <p class="text-center">Tonton video tutorial di bawah ini untuk mengetahui cara bergabung:</p>
                            <div class="text-center mt-4">
                                <a href="https://www.youtube.com/watch?v=Ou6r01rWWBA" class="btn btn-lg btn-info">Watch Tutorial</a>
                            </div>
                        </div>
                    </div>
                </div>
